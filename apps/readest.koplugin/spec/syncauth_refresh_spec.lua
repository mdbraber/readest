...
-- These stubs replace modules other spec files load from koreader_stubs /
-- spec_helper. busted runs every spec file in one Lua state, so save the
-- originals here and restore them in the file-level teardown below.
local STUBBED_MODULES = { "ui/widget/infomessage", "ui/widget/multiinputdialog", "ui/network/manager", "ui/uimanager", "util", "ffi/util", "readest_i18n", "readest_supabaseauth", "readest_syncauth" }
